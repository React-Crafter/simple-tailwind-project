        ...
        <nav className='bg-[#2d2d33] shadow-xl w-full'>
            <div className='container mx-auto'>
                <div className='py-5 items-center justify-between text-white sm:flex'>
                    ...
                    <ul className={`absolute shadow-xl py-4 text-center bg-slate-700 w-full flex-1 justify-end ${toggler == false ? 'top-[-100%]' : 'top-[10vh]'} duration-500 text-xl sm:flex sm:static sm:w-auto sm:bg-[#2d2d33] sm:py-0 sm:shadow-none`}>
