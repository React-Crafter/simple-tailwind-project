...
import Clientaria from '../Clientaria/Clientaria';
...
function Mainaria() {
  ...
  return (
    <div>
        <main>
            <section className='mt-10 sm:my-24 mb-24'>
                <h1 className='text-white text-3xl text-center mb-16'> Our Services </h1>
